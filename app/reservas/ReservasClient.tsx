          ...
          {step === 2 && (
            <>
              ...
              {slots.length > 0 && slots.every(s => !s.available) ? (
                <div style={{ background: '#fff', border: '1.5px solid #D8DAC8', borderRadius: 10, padding: '28px 20px', textAlign: 'center', marginBottom: 20 }}>
                  <div style={{ fontSize: 32, marginBottom: 12 }}>🍷</div>
                  <div style={{ fontSize: 16, fontWeight: 600, color: DARK, marginBottom: 8 }}>Sin disponibilidad</div>
                  <div style={{ fontSize: 13, color: '#888', lineHeight: 1.6 }}>
                    Lo sentimos, no hay mesas disponibles.<br />Podés elegir otra fecha.
                  </div>
                  <button style={{ ...btnBack, marginTop: 20, marginBottom: 0 }} onClick={() => goStep(1)}>← Elegir otra fecha</button>
                </div>
              ) : (
